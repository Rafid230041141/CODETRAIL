...
public class DsaProblemArenaWindow {
    ...
    private VBox buildTopHeader() {
        ...
        topicComboBox.setCellFactory(lv -> new ListCell<>() {
            @Override
            protected void updateItem(String item, boolean empty) {
                super.updateItem(item, empty);
                if (empty || item == null) {
    ...
    private Node buildRightEditorPane() {
        ...
        languageComboBox.getStyleClass().add("arena-lang-combobox");
        ...
        CodeSyntaxHighlighter.attachAsyncHighlighting(codeEditorArea, () -> currentLanguage, 50);
        ...
        editorStatusLabel.setStyle("-fx-font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; -fx-font-size: 11px; -fx-font-weight: 600; -fx-text-fill: #94a3b8;");
        ...
        editorLangBadge.setStyle("-fx-font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; -fx-font-size: 11.5px; -fx-font-weight: 700; -fx-text-fill: #60a5fa;");
    ...
    private void updateLineNumbers() {
        if (codeEditorArea != null && currentLanguage != null) {
            String text = codeEditorArea.getText();
            if (text != null) {
                CodeSyntaxHighlighter.applyHighlightingAsync(codeEditorArea, text, currentLanguage);
            }
        }
    }
