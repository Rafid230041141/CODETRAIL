...
public class LanguagesTopicsWindow {
    ...
    private static HBox buildTopToolbar(Stage stage, Window owner) {
        ...
        Button arenaHeaderBtn = new Button("Language Compiler & Arena");
    ...
    private static VBox buildSidebar(Stage stage, Consumer<String> onSelectModule) {
        ...
        Button arenaSidebarBtn = new Button("Language Compiler & Practice");
    ...
    private static VBox buildTopicCard(LanguagesTopic topic, Stage stage, Consumer<String> onSelectModule) {
        ...
        Button compilerBtn = new Button("Compiler Practice");
        compilerBtn.getStyleClass().add("topic-card-exercise-btn");
        ...
        contextMenu.getItems().addAll(compilerItem, copyItem, changeItem);
    ...
    public static ProgrammingLanguage getProgrammingLanguageForModule(String moduleKey) {
        if (moduleKey == null) return ProgrammingLanguage.PYTHON;
        String lower = moduleKey.toLowerCase(Locale.ROOT);
        if (lower.contains("python")) return ProgrammingLanguage.PYTHON;
